...
def load_config():
    ...
    """
    # Zmienna K_SERVICE jest automatycznie ustawiana przez Cloud Run.
...
def _load_from_secret_manager():
    ...
    secret_id = "trading-bot-secrets"  # Nazwa sekretu, który utworzyliśmy
    ...
    try:
        ...
        # Używamy biblioteki dotenv do sparsowania zawartości sekretu tak, jakby to był plik .env
        ...
        # W środowisku produkcyjnym można rozważyć zatrzymanie aplikacji, jeśli sekrety są kluczowe
        # raise e
